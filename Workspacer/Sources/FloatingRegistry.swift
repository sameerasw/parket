...
final class FloatingRegistry {
    ...
    private let legacyDefaultsKey = "parket.floatingWindows"
    private let defaultsKey = "workspacer.floatingWindows"
    ...
    private func loadPersisted() {
        if UserDefaults.standard.object(forKey: defaultsKey) == nil,
           let legacySaved = UserDefaults.standard.stringArray(forKey: legacyDefaultsKey) {
            UserDefaults.standard.set(legacySaved, forKey: defaultsKey)
        }
